...
const defaults = {
  ...
  news: [
    {
      title: 'دليل استقطاب أفضل الكفاءات',
      tag: 'دليل الشركات',
      text: 'خطوات عملية لبناء فريق قوي وتقليل وقت التوظيف.'
    },
    {
      title: 'محرك المطابقة الذكي',
      tag: 'تحديث المنصة',
      text: 'البحث بالخبرة والمهارات والمدينة في ثوانٍ.'
    }
  ]
};
...
function adminOK(profileData) {
  return Boolean(
    ...
    profileData.email &&
    profileData.email.toLowerCase() === process.env.ADMIN_EMAIL.toLowerCase()
  );
}
